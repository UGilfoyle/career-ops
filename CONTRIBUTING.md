...
- Report bugs via [Issues](https://github.com/UGilfoyle/career-ops/issues)
...
- **PRs that add centralized or hosted infrastructure to the core** (proxies, aggregation services, shared Workers). That's the separate opt-in service, not the open-core — bring it to the [direction discussion](https://github.com/UGilfoyle/career-ops/discussions) first.
...
- [Open an issue](https://github.com/UGilfoyle/career-ops/issues)
