...
export function cleanHtmlToStructuredJd(html) {
  if (!html) return '';
  return String(html)
...
export function detectKnownTech(text) {
...
export function extractBulletsFromBlock(block) {
...
export function parseJdSections(rawInput) {
