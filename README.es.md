...
<p align="center">
  Las empresas usan IA para descartarte. <strong>Career-Ops le da a los candidatos IA para <em>elegirlas</em>.</strong><br>
  <em>Open source y local-first.</em>
</p>
...
<p align="center"><strong>Evalúa ofertas · Personaliza CVs · Gestiona tu pipeline</strong></p>
...
Una herramienta de código abierto diseñada para gestionar y optimizar tu pipeline de búsqueda de empleo.
