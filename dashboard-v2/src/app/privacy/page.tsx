  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1C1C1E] p-8 md:p-24 selection:bg-[#1C1C1E]/10 font-sans">
      ...
      <div className="max-w-4xl">
        ...
        <p className="text-[#9CA3AF] text-xl mb-20 max-w-2xl font-medium leading-relaxed italic border-l-4 border-[#E5E5E0] pl-8">The Career-Ops Zero-Trust Manifest. We believe professional growth shouldn&apos;t compromise personal data integrity.</p>
        ...
        <div className="p-10 bg-white border border-[#E5E5E0] rounded-[2.5rem] flex items-center gap-8 shadow-2xl shadow-black/[0.02]">
          ...
          <div>
            ...
            <p className="text-[#6B6B6B] font-medium leading-relaxed">Your API keys are stored with AES-256 encryption. Our infrastructure never reads them in plain text outside of the secure execution runner.</p>
          </div>
        </div>
      </div>
    </div>
