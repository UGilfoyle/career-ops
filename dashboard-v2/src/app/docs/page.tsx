  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1C1C1E] p-8 md:p-24 selection:bg-[#1C1C1E]/10 font-sans">
      ...
      <div className="max-w-4xl">
        ...
        <p className="text-[#9CA3AF] text-xl mb-20 max-w-2xl font-medium leading-relaxed italic border-l-4 border-[#E5E5E0] pl-8">The technical foundation of Career-Ops. Learn how we use agentic AI to build the ultimate career command center.</p>
        ...
        <div className="mt-32 p-12 bg-white border border-[#E5E5E0] rounded-[2.5rem] shadow-2xl shadow-black/[0.02]">
          ...
          <p className="text-[#6B6B6B] text-lg leading-relaxed font-medium">Career-Ops uses a specialized RAG (Retrieval-Augmented Generation) pipeline that combines your career narrative with thousands of high-performing resume patterns to generate high-conversion applications on the fly.</p>
        </div>
      </div>
    </div>
  );
