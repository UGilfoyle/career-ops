/** Gemini Pro paste: AI-backend + easy-mode DSA handbook for Akash. */

export const HANDBOOK_REPO_PROMPT_PATH =
  'interview-prep/gemini-ai-dsa-handbook-prompt.md';

export const HANDBOOK_REPO_TRACKER_PATH = 'interview-prep/ai-dsa-handbook.md';

export const HANDBOOK_WEEKS: Array<{ week: number; title: string; focus: string }> = [
  {
    week: 1,
    title: 'Foundations',
    focus: 'DSA A–E (complexity → hash/window) + embeddings/RAG basics + 1 design warmup',
  },
  {
    week: 2,
    title: 'Trees, graphs, retrieval',
    focus: 'Trees/graphs/heaps + chunking/evals + RAG chat-with-PDFs design',
  },
  {
    week: 3,
    title: 'Search + LLM proxy',
    focus: 'Binary search, intervals, LRU, DP start + multi-model proxy design + 3 mocks',
  },
  {
    week: 4,
    title: 'Mocks',
    focus: 'Weak-topic drill + 4 timed mocks (DSA 45m + design 45m + AI concepts 20m)',
  },
];

export const GEMINI_AI_DSA_HANDBOOK_PROMPT = `You are my personal interview coach and technical writer. Build one complete PRACTICE HANDBOOK for me. Do not write a generic CS textbook. Do not dump LeetCode lists. Teach like a patient senior who makes hard things feel obvious.
...
/** Paste in the SAME Gemini chat if the first draft was text-only. */
export const GEMINI_HANDBOOK_VISUALS_FOLLOWUP = `Stop new chapters. The last draft is too text-heavy.
