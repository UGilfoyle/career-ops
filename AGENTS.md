...
This system evaluates job offers, generates tailored CVs, and manages the job search pipeline. The archetypes, scoring logic, negotiation scripts, and proof point structure are all designed to optimize search and evaluation.
...
| Wants to practice interactive mock interview | `mock-prep` |
| Wants to generate CV/PDF | `pdf` |
| Evaluates a course/cert | `training` |
| Evaluates project or scaffolds Exposure proof-of-work | `project` |
